function [z,dz]=bell3(x,y,val)
% BELL3(X,Y,VAL) - three-bell shaped spline function
%	waits for X - an argument array of dimension 5
%		  Y - a function peaks array of dimension 3 
