...
response_files = {  '38_dutch_roll_unconstrained.mat'
                    '35_dutch_roll_spherical_constrained_0_8_with_Fc_no_thrust_00delay.mat'
                    '36_dutch_roll_spherical_constrained_0_8_with_Fc_no_thrust_500delay.mat'
                    '37_dutch_roll_spherical_constrained_0_8_with_Fc_no_thrust_9000delay.mat'
...
%           x               	x_min   x_max   x_spacing	y                               y_min   y_max   y_spacing   y_label          	Colour    	Style
plots= {    '[t1 t2 t3 t4]'  	0       10      1           '[r1 r2 r3 r4]'                 -14     14    	7         	'$r$ (deg/s)'      	[0 0 0]   	'-|--|:|-.|-|x|-x' 
            '[t1 t2 t3 t4]'   	0       10      1           '[p1 p2 p3 p4]'                 -60     60      30         	'$p$ (deg/s)'       [0 0 0]   	'-|--|:|-.|-|x|-x'
            '[t1 t2 t3 t4]'  	0       10      1           '[alpha1 alpha2 alpha3 alpha4]'	1       2       0.5       	'$\alpha$ (deg)'  	[0 0 0]   	'-|--|:|-.|-|x|-x'
            '[t1 t2 t3 t4]'  	0       10      1           '[beta1 beta2 beta3 beta4]'     -2      2       1       	'$\beta$ (deg)'    	[0 0 0]   	'-|--|:|-.|-|x|-x'
            't4'            	0       10      1           '[drud1]'                       -4      4       2           '$\delta_r$ (deg)' 	[0 0 0]  	'-|--|:|-.|-|x|-x'
            };
...
print -deps DutchRoll4.eps
print('DutchRoll4','-dpdf','-r1000')