...
press_to_continue = 1; % 1: Need to press enter to continue after each estimation
...
for i = 1:length(param_file_list)
    ...
    excel_save(filename,data1,data2,data3,'Estimated_aerodynamic_parameters_EEM.xlsx');
