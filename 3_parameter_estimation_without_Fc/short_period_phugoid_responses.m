...
%             };
%           x                    	x_min   x_max   x_spacing	y                                             	y_min   y_max   y_spacing   y_label          	Colour    	Style
plots= {    '[t1 t2 t3 t4 t5 t6]'  	0       10      1           '[q1 q2 q3 q4 q5 q6]'                         	-30     30     	10         	'$q$ (deg/s)'      	[0 0 0]   	'-|--|:|-.' 
            '[t1 t2 t3 t4 t5 t6]' 	0       10      1           '[alpha1 alpha2 alpha3 alpha4 alpha5 alpha6]'	-2       6       2           '$\alpha$ (deg)'  	[0 0 0]   	'-|--|:|-.'
            '[t1 t2 t3 t4 t5 t6]' 	0       10      1           '[z1 z2 z3 z4 z5 z6]'                         	-2      2       1           '$z$ (m)'        	[0 0 0]   	'-|--|:|-.'
    ...
    if i== size(plots,1)
   	...
   	if i == 1
        ...
        plot(t1(indexOfInterest),q1(indexOfInterest),...
             ...
             t4(indexOfInterest),q4(indexOfInterest),...
  	...
  	if i == 2
        ...
        plot(t1(indexOfInterest),alpha1(indexOfInterest),...
             ...
             t4(indexOfInterest),alpha4(indexOfInterest),...
...
step = 100;          % Gap between aircrafts on plot
exagg_factor = 5;
...
scale_factor = 6;   % For aircraft on plot
step = 500;         % Gap between aircrafts on plot ( time gap = step*t1(2) )
exagg_factor = 1;
