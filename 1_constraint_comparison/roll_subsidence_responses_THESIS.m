...
%             };
%           x                         	x_min   x_max   x_spacing	y                                               y_min   y_max   y_spacing   y_label          	Colour    	Style
plots= {    '[t1 t2 t3 t4 t5 t6]'       0       5       0.5        	'[p1 p2 p3 p4 p5 p6]'                           -10    	30  	10         	'$p$ (deg/s)'     	[0 0 0]   	'-|--|:|-.' 
            '[t1 t2 t3 t4 t5 t6]'   	0       5       0.5         '[phi1 phi2 phi3 phi4 phi5 phi6]'               -10    	20      10         	'$\phi$ (deg)'    	[0 0 0]   	'-|--|:|-.'
            '[t1 t2 t3 t4 t5 t6]'   	0       5       0.5         '[alpha1 alpha2 alpha3 alpha4 alpha5 alpha6]'  	1    	2       0.5       	'$\alpha$ (deg)'  	[0 0 0]   	'-|--|:|-.'
            '[t1 t2 t3 t4 t5 t6]'   	0       5       0.5         '[beta1 beta2 beta3 beta4 beta5 beta6]'         -1    	1       0.5       	'$\beta$ (deg)'    	[0 0 0]   	'-|--|:|-.'
            't4'                     	0       5       0.5         '[dail1]'                                       -1      1       0.5        	'$\delta_a$ (deg)' 	[0 0 0]  	'-|--|:|-.'
            };
...
print -deps RollSubsidence1_THESIS.eps
print('RollSubsidence1_THESIS','-dpdf','-r1000')
