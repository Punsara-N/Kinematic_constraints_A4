...
%           x                       x_min   x_max   x_spacing	y                         	y_min   y_max   y_spacing   y_label          	Colour    	Style
plots= {    '[t1 t3 t5 t6]'  	1.5    	3       0.25       	'[phi1 phi3 phi5 phi6]'      	-40   	20     	20         	'$\phi$ (deg)'     	[0 0 0]   	'-|--|:|-.'
            '[t1 t3 t5 t6]' 	1.5    	3       0.25       	'[alpha1 alpha3 alpha5 alpha6]'	1       2     	0.5       	'$\alpha$ (deg)'   	[0 0 0]   	'-|--|:|-.'
            '[t1 t3 t5 t6]'  	1.5    	3       0.25       	'[beta1 beta3 beta5 beta6]'   	-1      1       1         	'$\beta$ (deg)'    	[0 0 0]   	'-|--|:|-.'
            '[t1 t3 t5 t6]'  	1.5    	3       0.25     	'[V1 V3 V5 V6]'                	27      31      2       	'$V$ (m/s)'         [0 0 0]   	'-|--|:|-.'
            '[t1 t3 t5 t6]'  	1.5    	3       0.25      	'[z1 z3 z5 z6]'               	-0.1    0.1    	0.1       	'$z$ (m)'           [0 0 0]   	'-|--|:|-.'
