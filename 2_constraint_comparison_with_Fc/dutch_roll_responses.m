...
%% CHECK
load('18_3_dutch_roll_spherical_constrained_0_8_no_Fc_no_thrust_no_X_check');
...
plot1.Position = plot1.Position + [0 -7.6 0 0];
plot6.Position = plot6.Position + [0 -7.6 0 0];
